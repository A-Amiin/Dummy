...
import { viewServicesDetails } from "../network/servicesApis";
...
export default function ServiceDetails() {
	...
	const serviceData = useSelector(
		(state) => state.services.servicesDetailsData
	);
	const dispatch = useDispatch();

	useEffect(() => {
		dispatch(viewServicesDetails(serviceId));
	}, [dispatch]);
	return (
		<>
			{/* <!-- banner --> */}
			<HeadBanner prevPage={segments[1]} currPage={serviceData.role} />
